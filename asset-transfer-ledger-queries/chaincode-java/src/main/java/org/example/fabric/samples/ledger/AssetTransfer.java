...
public final class AssetTransfer implements ContractInterface {
     ...
     */
    @Transaction(intent = Transaction.TYPE.EVALUATE)
    public List<Asset> getAssetsByRange(final Context ctx, final String startKey, final String endKey) {
     ...
     */
    @Transaction(intent = Transaction.TYPE.EVALUATE)
    public List<Asset> queryAssetsByOwner(final Context ctx, final String owner) {
     ...
     */
    @Transaction(intent = Transaction.TYPE.EVALUATE)
    public List<Asset> queryAssets(final Context ctx, final String queryString) {
        return getQueryResultForQueryString(ctx, queryString);
    }
     ...
     */
    @Transaction(intent = Transaction.TYPE.EVALUATE)
    public List<Asset> getAssetsByRangeWithPagination(final Context ctx, final String startKey, final String endKey,
     ...
     */
    @Transaction(intent = Transaction.TYPE.EVALUATE)
    public PaginatedQueryResult queryAssetsWithPagination(final Context ctx, final String queryString,
                                                          final int pageSize, final String bookmark) {
     ...
     */
    @Transaction(intent = Transaction.TYPE.EVALUATE)
    public List<HistoryQueryResult> getAssetHistory(final Context ctx, final String assetID) {
